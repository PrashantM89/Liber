package org.app.liber.fragment;
...
public class ProfileInputDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final TextView textView = (TextView) promptView.findViewById(R.id.my_profile_dialog_label);
        final EditText editText = (EditText) promptView.findViewById(R.id.my_profile_dialog_input);
        final TextView hintView = (TextView) promptView.findViewById(R.id.my_profile_dialog_hint);

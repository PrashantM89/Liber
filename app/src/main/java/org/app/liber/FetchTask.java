...
class FetchTask extends AsyncTask<String,Void , ArrayList<Book>> {
    ...
    // Constructor
    public FetchTask(AsyncResponse delegate, String queryURI, int maxResults, Context context) {
        ...
        if (jsonResults != null) {
            try {
                ...
                for (int i = 0; i < countResults; i++) {
                    ...
                    Book mBook = new Book(bookTitle, bookAuthorsString, bookSmallThumbnail,bookDescription, genre, avgRating);
                    // Add it to the array
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage(context.getString(R.string.processing_label));
